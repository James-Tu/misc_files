...
#define	IRQ_SUB_AC97_OFT	14
#define	IRQ_SUB_WDT_OFT		13
#define	IRQ_SUB_CAM_P_OFT	12
#define	IRQ_SUB_CAM_C_OFT	11
#define	IRQ_SUB_ADC_S_OFT	10
#define	IRQ_SUB_TC_OFT		9
#define	IRQ_SUB_ERR2_OFT	8
#define	IRQ_SUB_TXD2_OFT	7
#define	IRQ_SUB_RXD2_OFT	6
#define	IRQ_SUB_ERR1_OFT	5
#define	IRQ_SUB_TXD1_OFT	4
#define	IRQ_SUB_RXD1_OFT	3
#define	IRQ_SUB_ERR0_OFT	2
#define	IRQ_SUB_TXD0_OFT	1
#define	IRQ_SUB_RXD0_OFT	0
